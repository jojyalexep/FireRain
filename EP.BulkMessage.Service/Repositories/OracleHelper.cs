...
namespace EP.BulkMessage.Service.Repositories
{
    public sealed class OracleHelper
    {
        ...
        private static void PrepareCommand(OracleCommand command, OracleConnection connection, OracleTransaction transaction, CommandType commandType, string commandText, OracleParameter[] commandParameters, out bool mustCloseConnection)
        {
            ...
            //commented because explicit transaction setting not required for the oracledataaccess
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            ...
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                ...
                retVal = ExecuteNonQuery(connection, commandType, commandText, commandParameters);
        ...
        /// <summary>
        /// Execute a OracleCommand (that returns no resultset and takes no parameters) against the provided OracleConnection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ///  int result = ExecuteNonQuery(conn, CommandType.StoredProcedure, "PublishOrders");
        ...
        /// <param name="commandText">The stored procedure name or T-Oracle command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(Boolean externalconnectionstring, string connectionString, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if (externalconnectionstring == false)
                return 0;

            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");

            // Create & open a OracleConnection, and dispose of it after we are done
            using (OracleConnection connectionobj = new OracleConnection(connectionString))
            {
                connectionobj.Open();
                ...
                PrepareCommand(cmd, connectionobj, (OracleTransaction)null, commandType, commandText, commandParameters, out mustCloseConnection);
        ...
        /// <param name="commandParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        /// commented to rectify hanging issue
        ...
        //Added to rectify hanging issue.
        public static int ExecuteNonQuery(OracleConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            //if (connection == null) throw new ArgumentNullException("connection");

            //newly added to make sure that if any connection object comes into this function with opened status, it should be closed.
            if (connection != null)
            {
                if (connection.State == ConnectionState.Open)
                {
        ...
        /// <param name="commandParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>A dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(Boolean externalconnectionstring, string connectionString, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            if (externalconnectionstring == false)
                return null;
        ...
        /// <param name="commandParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>A dataset containing the resultset generated by the command</returns>
        /// commented code to rectify the hanging problem
        ...
        // newly added  code to rectify the hanging problem
        public static DataSet ExecuteDataset(OracleConnection connection, CommandType commandType, string commandText, params OracleParameter[] commandParameters)
        {
            //if( connection == null ) throw new ArgumentNullException( "connection" );
            //newly added to make sure that if any connection object comes into this with opened status should be closed
            if (connection != null)
            {
                if (connection.State == ConnectionState.Open)
                {
        ...
        ////newly added to rectify hanging issue.
        //private static OracleDataReader ExecuteReader(OracleConnection connection, OracleTransaction transaction, CommandType commandType, string commandText, OracleParameter[] commandParameters, OracleConnectionOwnership connectionOwnership)
        //{
        //    //if( connection == null ) throw new ArgumentNullException( "connection" );
        //    //newly added to make sure that if any connection object comes into this with opened status should be closed
        ...
        //    {
        //        // Create & open a OracleConnection, and dispose of it after we are done
        //        using (OracleConnection connectionobj = new OracleConnection(OracleDBConstants.ConnectionString))
        //        {

        //                connectionobj.Open();
        //                PrepareCommand(cmd, connectionobj, transaction, commandType, commandText, commandParameters, out mustCloseConnection);
